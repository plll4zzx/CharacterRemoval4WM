...
python test_ga_sh.py --llm_name "../model/Llama3.1-8B_hg" --wm_name "KGW" --atk_style "char" --ori_flag "False" --data_aug 9 --ab_std -1 --device 1 --remove_spoof "True"
python test_ga_sh.py --llm_name "../model/Llama3.1-8B_hg" --wm_name "Unigram" --atk_style "char" --ori_flag "False" --data_aug 9 --ab_std -1 --device 1 --remove_spoof "True"