...
def get_watermark_data(
    ...
    if wm_type=='es':
        mww=ModelWithEswm(model_name, load_fp16=load_fp16)#use_gpu=False,
    else:
...
if __name__=='__main__':
    ...
    wm_level_list = ['token']#'model', 'sentence_fi'
    
    model_name_list= ['../model/llama-2-7b',]#'facebook/opt-1.3b', 'openlm-research/open_llama_7b_v2', 'facebook/opt-2.7b', 'facebook/opt-6.7b', 'facebook/opt-1.3b', 'microsoft/phi-2', 
    finit_key_num=3
